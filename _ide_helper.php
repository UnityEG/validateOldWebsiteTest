...
namespace {
    ...
    class Facebook extends \SammyK\LaravelFacebookSdk\FacebookFacade{
         ...
         *
         * @param \SammyK\LaravelFacebookSdk\FacebookAuthInterface $auth
         * @static 
         */
        public static function setAuthDriver($auth){
            return \SammyK\LaravelFacebookSdk\LaravelFacebookSdk::setAuthDriver($auth);
        }
        
        /**
         * Return the authentication driver
         *
         * @return \SammyK\LaravelFacebookSdk\FacebookAuthInterface 
         * @static 
         */
        public static function auth(){
            return \SammyK\LaravelFacebookSdk\LaravelFacebookSdk::auth();
        }
        
        /**
         * Return the Facebook Query Builder object
         *
         * @return \SammyK\LaravelFacebookSdk\FQB 
         * @static 
         */
        public static function fqb(){
            return \SammyK\LaravelFacebookSdk\LaravelFacebookSdk::fqb();
        }
         ...
         * @static 
         */
        public static function getTokenFromRedirect($callback_url = ''){
            return \SammyK\LaravelFacebookSdk\LaravelFacebookSdk::getTokenFromRedirect($callback_url);
        }
         ...
         * @static 
         */
        public static function extend($closure_name, $closure){
            return \SammyK\LaravelFacebookSdk\LaravelFacebookSdk::extend($closure_name, $closure);
        }
