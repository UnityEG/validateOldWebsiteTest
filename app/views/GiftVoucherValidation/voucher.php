...
// include functions
include('voucher/s_functions.php');
...
// Date Handling
	$date_array = explode("-", $delivery_date);
$date_issued = $date_array[2] . '/' . $date_array[1] . '/' . $date_array[0];
	$date_array = explode("-", $expiry_date);
$v_expiry_date = $date_array[2] . '/' . $date_array[1] . '/' . $date_array[0];
//
...
imagettftext($im, 45, 0, $merchant_name_x, $merchant_name_y, $text_color, $font, $merchant_name);
imagettftext($im, 15, 0, $merchant_info_x, $merchant_info_y, $text_color, $font, $merchant_info);
imagettftext($im, 20, 0, 520, 218, $text_color, $font, $amount);
imagettftext($im, 15, 0, 405, 250, $text_color, $font, $date_issued);
