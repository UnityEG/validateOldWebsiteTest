...
<div class="forms-back">
    <div align="right">{{ link_to_route('GiftVouchersParameters.index', 'List all Gift Vouchers Parameter') }}</div>
    <h2 style="margin-top:-4%;">Edit Gift Vouchers Parameters</h2>
    {{ Form::model($GiftVouchersParameter, array('method' => 'PATCH','onsubmit' => 'min_max_check()' , 'route' => array('GiftVouchersParameters.update', $GiftVouchersParameter->id))) }}
    <div class="row">
    ...
    @else
        ...
        {{ Form::select('MerchantID', Merchant::lists('business_name','id'), null, array('class'=>'form-control', 'placeholder'=>'Select Merchant')) }}
            </div>
     ...
     @endif
        ...
        {{ Form::text('Title', null, array('class'=>'form-control', 'placeholder'=>'Enter a title for your gift voucher e.g. Gift Voucher','style'=>'width:100% !important;')) }}
            </div>
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 ">	
            ...
            <div class="form-group">
                ...
                {{ Form::text('MinVal', null, array('id'=>'minVal', 'class'=>'form-control', 'placeholder'=>'Minimum value for a Gift Voucher is $20.00','style'=>'display:inline-block;width:100%;')) }}
            </div>
            <div class="form-group">
