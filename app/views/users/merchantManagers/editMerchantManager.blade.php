...
{{Form::model($item, array('route'=>array('merchant_manager.update', $item->id), 'method'=>'put', 'role'=>'form'))}}
<div class="row">
...
<div class="form-group">
    ...
    {{Form::checkbox('active_merchant_manager', true, $checked)}}
...
<div class="form-group">
    ...
    {{link_to_route('merchant_manager.show', 'Cancel', array($item->id), array('class'=>'btn btn-danger'))}}
</div>
